//
//  HHHMyVideoListViewController.m
//  ModelProduct
//
...
#import "HHHMyVideoCell.h"
#import <MediaPlayer/MediaPlayer.h>

@interface HHHMyVideoListViewController ()<UITableViewDataSource,UITableViewDelegate>
...
@implementation HHHMyVideoListViewController
...
- (void)initSubViews {
    ...
    NSArray *audioList=[[FileManager shareIntance] getAllVideoItems];
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    static NSString *Identifier=@"HHHMyVideoCell";
...
- (void)tableView:(UITableView *)tableView commitEditingStyle:(UITableViewCellEditingStyle)editingStyle forRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    [[FileManager shareIntance] removeVideoFilePathWithItemName:[_titles objectAtIndex:indexPath.row]];

...
@interface HHHMeiTuNewViewController ()<UITableViewDataSource,UITableViewDelegate>
...
@implementation HHHMeiTuNewViewController
...
- (void)meiTuNewRequest {
    
    NSString *str_url=[NSString stringWithFormat:@"http://b.appcq.cn/newest?expand=randomImage&page=%ld&per-page=%ld",(long)_page,(long)_pageSize];
